	...
	_jQuery2.default.widget('blueimpUIX.fileupload', _jQuery2.default.blueimpUI.fileupload, {
		...
		_onAdd: function _onAdd(e, data) {
			...
			if (data.files.length == 1 && data.files[0].error !== null) {
				...
				(0, _jQuery2.default)('.fileOverview .uploadStatus .state').text(_i18n2.default._t('AssetUploadField.UPLOADINPROGRESS', 'Please wait… upload in progress')); //.show();
		...
		_onAlways: function _onAlways(jqXHRorResult, textStatus, jqXHRorError, options) {
			...
			if (typeof jqXHRorError === 'string') {
				...
				(0, _jQuery2.default)('.fileOverview .uploadStatus .state').text(_i18n2.default._t('AssetUploadField.FILEUPLOADCOMPLETED', 'File upload completed!')); //.hide();
